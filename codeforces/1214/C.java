...
////////////////////////////////////Code Start/////////////////////////////////////////////////    
    ...
    public static void solve() {
        ...
        if((count==1 && st.size()==1) || (!f && st.size()==0)){
...
////////////////////////////////////Code End//////////////////////////////////////////////////
     ...
     static void permutations(ArrayList<Integer> a,int n,ArrayList<Integer> arr){
     	if(n==0){
     		System.out.println(arr);
     		return;
        }
     	for(int i=0;i<a.size();i++){
     	    ...
     	    arr.add(x);
            a.remove(i);
     	    permutations(a,n-1,arr);
     	    a.add(x);
     	    arr.remove(a.get(a.size()-1));
     	}
