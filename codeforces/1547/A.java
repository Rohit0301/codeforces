...
if(x1==x2){
    ...
    if(x3==x1 && y3>Math.min(y1,y2) && y3<Math.max(y1,y2)){
        System.out.println(abs(y2-y1)+2);
    }
    else{
        System.out.println(abs(y2-y1));
    }
    return;
}
...
if(y1==y2){
    ...
    if(y3==y1 && x3<Math.max(x1,x2) && x3>Math.min(x1,x2)){
        System.out.println(abs(x2-x1)+2);
    }
    else{
        System.out.println(abs(x2-x1));
    }
    return;
}

System.out.println(abs(y2-y1)+abs(x2-x1));
...
static long mins(long a,long b){
    return Math.min(a,b);
}
static long maxs(long a,long b){
    return Math.max(a,b);
}
